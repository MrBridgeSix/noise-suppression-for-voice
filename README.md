...
To change the VAD Threshold click the downward chevrons select "Edit text" and input the following text: VSTPlugin: Library librnnoise_vst.dll "VAD Threshold" 0.95 (or any other value between 0 and 1).
